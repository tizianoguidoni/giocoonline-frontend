...
import { Swords, Mail, Lock, ArrowLeft } from 'lucide-react';
        ...
        <div className="gold-framed-panel rounded-2xl p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-[#A19BAD]">
              {t('noAccount')}{' '}
              <Link to="/register" className="text-[#D4AF37] hover:text-[#FADB5F] transition-colors" data-testid="register-link">
                {t('register')}
              </Link>
            </p>
          </div>
